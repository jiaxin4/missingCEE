## Here are the necessary functions for the simulations
library(rootSolve) 
library(mgcv)
...
# Specification 1. correct + correct -------------------------------------------------------
...
# Specification 3. mis + correct -------------------------------------------------------
setting_list <- list(list(setting = 31, func_type = "linear", alpha1 = -0.5, lambda2 = 1.5), 
                     list(setting = 32, func_type = "beta", alpha1 = -2, lambda2 = 1.5), 
